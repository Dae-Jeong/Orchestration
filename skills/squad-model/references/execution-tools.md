...
이 절은 **합의한 운영 설계**다. [첫 문서 시범](../../../tasks/first-live-pilot.md)에서
PM이 Paperclip 상태를 연결하며 Orca QA→HR 배정·결과·검증·후속 재개를 실행했다.
자동 adapter/동기화, 상시 PM, 여러 제품의 자동 실행은 아직 구현·검증하지 않았다.
