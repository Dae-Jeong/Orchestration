...
여러 제품의 소재와 목표를 PM 중심으로 조율하고, 기획·디자인·개발·QA의 작업과
완료 조건·권한·검증 증거를 연결하는 개인 오케스트레이션 모델입니다.
사용자가 방향과 허용 범위를 정하면 PM이 프레임워크를 적용해 업무를 배정하고,
각 역할이 상세 실행과 인계를 맡습니다.

이 README가 프로젝트의 시작 문서입니다. 역할별 계약은 `skills/squad-model/`,
검증과 결정 기록은 `tasks/`에서 관리합니다.
